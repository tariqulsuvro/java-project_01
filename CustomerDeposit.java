...
public class  CustomerDeposit extends JFrame implements ActionListener
{
	private JPanel panel;
	private JButton info,manageCustomer,deposit,passChngRequest,logOut,bttn;
	...
	String Bank_id;
	private static double value=0,value1=0,solve=0;

	
	
	public CustomerDeposit(String Bank_id)
	{
		...
		manageCustomer.setBounds(xAxis,yAxis+40,width,height);
		...
		deposit.setBounds(xAxis,yAxis+80,width,height);
		...
		passChngRequest.setBounds(xAxis,yAxis+120,width,height);
